...
<?php
	...
	$package3_title				= get_field('package3_title');
	$package3_text				= get_field('package3_text');
	$package3_price				= get_field('package3_price');
		    		...
		    		<div class="col-sm-8">
		    			<div id="price-timeline">
			            	...
			            	<div class="price special">
			            		<h4><em>"<?php echo $package3_title; ?>"</em><br><?php echo $package3_text; ?></h4>
			            		<span><?php echo $package3_price; ?></span>
			            	</div><!-- end price -->
			            </div><!-- price-timeline -->
		    		</div>
		...
		<div class="container">
			<div class="col-sm-12">
				...
				<div class="row">
					...
					<?php $loop = new WP_Query( array(  'post_type' => 'lesson_prices') ); ?>
				...
				<div class="row">
					...
					<?php $loop = new WP_Query( array(  'post_type' => 'lesson_prices_large' ) ); ?>
			...
			<div class="col-sm-12" id="packages">
				...
				<div class="row">
					...
					<?php $loop = new WP_Query( array(  'post_type' => 'package_prices' ) ); ?>
			...
			<div class="col-sm-12">
				<div class="row">
					<ul class="col-sm-6">
						...
						<?php $loop = new WP_Query( array(  'post_type' => 'prices_bullets_col1' ) ); ?>
					...
					<ul class="col-sm-6">
						...
						<?php $loop = new WP_Query( array(  'post_type' => 'prices_bullets_col2' ) ); ?>
...
<!-- CONTACT
	...
	<section id="contact" data-type="background">
		<div class="container">
			<div class="row">
...
<!-- CONTACT FORM
	...
	<?php echo do_shortcode("[accordions id='103']"); ?>
